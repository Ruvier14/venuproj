        ...
        <div className="right-section" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div className="burger-wrapper" ref={burgerRef}>
            ...
            {burgerOpen && (
              ...
              >
                <button className="menu-item" type="button" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', width: '100%', background: 'transparent', border: 'none', textAlign: 'left', cursor: 'pointer', fontSize: '14px', color: '#222' }} onClick={() => router.push('/wishlist')}>
                  Wishlist
                </button>
                ...
                <button className="menu-item" type="button" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', width: '100%', background: 'transparent', border: 'none', textAlign: 'left', cursor: 'pointer', fontSize: '14px', color: '#222' }} onClick={() => router.push('/profile')}>
                  Account Settings
                </button>
